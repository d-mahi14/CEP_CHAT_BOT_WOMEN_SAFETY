...
// Rule-based classifier — upgrade to Claude API later
// =====================================================
...
router.post('/trigger', authenticateUser, async (req, res) => {
  try {
    ...
    // Notify emergency contacts (async — don't block response)
...
// Logs notification records — integrate Twilio/email later
// =====================================================
